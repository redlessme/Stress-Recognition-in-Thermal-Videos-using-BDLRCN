...
import time
import datetime
#the code is adapt from https://github.com/liu-zhy/vidtools/blob/main/extract_frames.py

#pre-processing the video data: you dont need to run pre-processing code as the pre-processed data is provided

#31 videos and 20 "film" for each video, we finally sample 28 frame for each flim.
#step 1: change args_argument according to your aim, then run frame_extraction.py to extract
# frames from videos

#Spend 0:08:48 to process data
